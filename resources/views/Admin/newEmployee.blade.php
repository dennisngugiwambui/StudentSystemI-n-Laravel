                    ...
                    <div class="card mb-3 border-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="photographPath" name="photograph_path" accept="image/*" capture="environment">
                                <button type="button" class="btn btn-secondary mt-2" id="takePhotoButton">Take Photo</button>
                            </div>
                        </div>
                    </div>
